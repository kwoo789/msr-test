        ...
        %else%			
    		...
    		%endif%
				...
				%ifvar defineAuthorized equals('true')%
					...
					%endif%
				%else%
						%ifvar checkpointAutomatic equals('false')% Manual
						    %else% 
							Automatic
						    %endif%
				%endif%
				...
				%ifvar defineAuthorized equals('true')%
					...
					%endif%
				%else%
						%ifvar rollbackAutomatic equals('false')% Manual
						    %else% 
							Automatic
						    %endif%
				%endif%
          ...
          %endif%
				...
				<TR>
					<script> writeTD("row"); </script>Reload Packages</TD>
					<script> writeTD("rowdata-l", "nowrap"); </script> 
				%ifvar defineAuthorized equals('true')%
						<INPUT onchange="enableSaveProperties();" type="radio" name="reloadPackages" value="true"
							%ifvar reloadPackages equals('true')% checked %endif%>Yes
						<INPUT onchange="enableSaveProperties();" type="radio" name="reloadPackages" value="false"
							%ifvar reloadPackages equals('false')% checked %endif%>No
				%else%
						%ifvar reloadPackages equals('true')% Yes %else% No %endif%
				%endif%
				</TR>
